...
pub async fn create_address(
    ...
    multipart_form_params
        .insert("CustomerName", params.customer_name.to_string());
    ...
    if let Some(param_value) = params.emergency_enabled {
        multipart_form_params
            .insert("EmergencyEnabled", param_value.to_string());
    }
    if let Some(param_value) = params.auto_correct_address {
        multipart_form_params
            .insert("AutoCorrectAddress", param_value.to_string());
    }
    if let Some(param_value) = params.street_secondary {
        multipart_form_params
            .insert("StreetSecondary", param_value.to_string());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateAddressError> =
...
pub async fn delete_address(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteAddressError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn fetch_address(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchAddressError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_address(
    ...
    if let Some(ref param_value) = params.customer_name {
        req_builder =
            req_builder.query(&[("CustomerName", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = params.emergency_enabled {
        req_builder = req_builder
            .query(&[("EmergencyEnabled", &param_value.to_string())]);
    }
    if let Some(ref param_value) = params.iso_country {
        req_builder =
            req_builder.query(&[("IsoCountry", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListAddressError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn update_address(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateAddressError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
