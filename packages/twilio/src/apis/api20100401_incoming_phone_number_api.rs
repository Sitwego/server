...
pub struct CreateIncomingPhoneNumberParams {
    ...
    pub emergency_status:
        Option<models::IncomingPhoneNumberEnumEmergencyStatus>,
    ...
    pub voice_receive_mode:
        Option<models::IncomingPhoneNumberEnumVoiceReceiveMode>,
...
pub async fn create_incoming_phone_number(
    ...
    models::ApiV2010AccountIncomingPhoneNumber,
...
> {
    ...
    if let Some(param_value) = params.sms_application_sid {
        multipart_form_params
            .insert("SmsApplicationSid", param_value.to_string());
    }
    if let Some(param_value) = params.sms_fallback_method {
        multipart_form_params
            .insert("SmsFallbackMethod", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.voice_application_sid {
        multipart_form_params
            .insert("VoiceApplicationSid", param_value.to_string());
    }
    if let Some(param_value) = params.voice_caller_id_lookup {
        multipart_form_params
            .insert("VoiceCallerIdLookup", param_value.to_string());
    }
    if let Some(param_value) = params.voice_fallback_method {
        multipart_form_params
            .insert("VoiceFallbackMethod", param_value.to_string());
    }
    if let Some(param_value) = params.voice_fallback_url {
        multipart_form_params
            .insert("VoiceFallbackUrl", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.emergency_status {
        multipart_form_params
            .insert("EmergencyStatus", param_value.to_string());
    }
    if let Some(param_value) = params.emergency_address_sid {
        multipart_form_params
            .insert("EmergencyAddressSid", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.voice_receive_mode {
        multipart_form_params
            .insert("VoiceReceiveMode", param_value.to_string());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateIncomingPhoneNumberError> =
...
pub async fn delete_incoming_phone_number(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteIncomingPhoneNumberError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchIncomingPhoneNumberError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_incoming_phone_number(
    ...
    models::ListIncomingPhoneNumberResponse,
    Error<ListIncomingPhoneNumberError>,
> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers.json",
        configuration.base_path,
    ...
    if let Some(ref param_value) = params.friendly_name {
        req_builder =
            req_builder.query(&[("FriendlyName", &param_value.to_string())]);
    }
    if let Some(ref param_value) = params.phone_number {
        req_builder =
            req_builder.query(&[("PhoneNumber", &param_value.to_string())]);
    }
    if let Some(ref param_value) = params.origin {
        req_builder =
            req_builder.query(&[("Origin", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListIncomingPhoneNumberError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateIncomingPhoneNumberError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
