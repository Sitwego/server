...
pub async fn list_available_phone_number_voip(
    ...
    models::ListAvailablePhoneNumberVoipResponse,
    Error<ListAvailablePhoneNumberVoipError>,
> {
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Voip.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), CountryCode=crate::apis::urlencode(params.country_code));
    let mut req_builder =
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListAvailablePhoneNumberVoipError> =
