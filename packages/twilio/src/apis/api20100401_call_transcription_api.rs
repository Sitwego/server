...
pub async fn create_realtime_transcription(
    ...
    models::ApiV2010AccountCallRealtimeTranscription,
...
> {
    ...
    if let Some(param_value) = params.status_callback_url {
        multipart_form_params
            .insert("StatusCallbackUrl", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.inbound_track_label {
        multipart_form_params
            .insert("InboundTrackLabel", param_value.to_string());
    }
    if let Some(param_value) = params.outbound_track_label {
        multipart_form_params
            .insert("OutboundTrackLabel", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.transcription_engine {
        multipart_form_params
            .insert("TranscriptionEngine", param_value.to_string());
    }
    if let Some(param_value) = params.profanity_filter {
        multipart_form_params
            .insert("ProfanityFilter", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.enable_automatic_punctuation {
        multipart_form_params
            .insert("EnableAutomaticPunctuation", param_value.to_string());
    }
    if let Some(param_value) = params.intelligence_service {
        multipart_form_params
            .insert("IntelligenceService", param_value.to_string());
    }
    if let Some(param_value) = params.conversation_configuration {
        multipart_form_params
            .insert("ConversationConfiguration", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.enable_provider_data {
        multipart_form_params
            .insert("EnableProviderData", param_value.to_string());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateRealtimeTranscriptionError> =
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateRealtimeTranscriptionError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
