...
pub async fn create_sip_domain(
    ...
    if let Some(param_value) = params.voice_status_callback_url {
        multipart_form_params
            .insert("VoiceStatusCallbackUrl", param_value.to_string());
    }
    if let Some(param_value) = params.voice_status_callback_method {
        multipart_form_params
            .insert("VoiceStatusCallbackMethod", param_value.to_string());
    }
    if let Some(param_value) = params.sip_registration {
        multipart_form_params
            .insert("SipRegistration", param_value.to_string());
    }
    if let Some(param_value) = params.emergency_calling_enabled {
        multipart_form_params
            .insert("EmergencyCallingEnabled", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.emergency_caller_sid {
        multipart_form_params
            .insert("EmergencyCallerSid", param_value.to_string());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateSipDomainError> =
...
pub async fn delete_sip_domain(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteSipDomainError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn fetch_sip_domain(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchSipDomainError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_sip_domain(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListSipDomainError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn update_sip_domain(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateSipDomainError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
