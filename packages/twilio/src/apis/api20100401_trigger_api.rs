...
pub async fn create_usage_trigger(
    ...
    models::ApiV2010AccountUsageUsageTrigger,
...
> {
    ...
    multipart_form_params
        .insert("CallbackUrl", params.callback_url.to_string());
    multipart_form_params
        .insert("TriggerValue", params.trigger_value.to_string());
    multipart_form_params
        .insert("UsageCategory", params.usage_category.to_string());
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateUsageTriggerError> =
...
pub async fn delete_usage_trigger(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteUsageTriggerError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchUsageTriggerError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_usage_trigger(
    ...
    if let Some(ref param_value) = params.recurring {
        req_builder =
            req_builder.query(&[("Recurring", &param_value.to_string())]);
    }
    if let Some(ref param_value) = params.trigger_by {
        req_builder =
            req_builder.query(&[("TriggerBy", &param_value.to_string())]);
    }
    if let Some(ref param_value) = params.usage_category {
        req_builder =
            req_builder.query(&[("UsageCategory", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListUsageTriggerError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateUsageTriggerError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
