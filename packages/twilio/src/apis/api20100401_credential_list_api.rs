...
pub async fn create_sip_credential_list(
    ...
    models::ApiV2010AccountSipSipCredentialList,
...
> {
    ...
    multipart_form_params
        .insert("FriendlyName", params.friendly_name.to_string());
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateSipCredentialListError> =
...
pub async fn delete_sip_credential_list(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteSipCredentialListError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchSipCredentialListError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_sip_credential_list(
    ...
    models::ListSipCredentialListResponse,
    Error<ListSipCredentialListError>,
> {
    let uri_str = format!(
        "{}/2010-04-01/Accounts/{AccountSid}/SIP/CredentialLists.json",
        configuration.base_path,
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListSipCredentialListError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateSipCredentialListError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
