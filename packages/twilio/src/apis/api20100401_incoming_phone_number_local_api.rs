...
pub struct CreateIncomingPhoneNumberLocalParams {
    ...
    pub emergency_status:
        Option<models::IncomingPhoneNumberLocalEnumEmergencyStatus>,
    ...
    pub voice_receive_mode:
        Option<models::IncomingPhoneNumberLocalEnumVoiceReceiveMode>,
...
> {
    ...
    multipart_form_params
        .insert("PhoneNumber", params.phone_number.to_string());
...
pub async fn list_incoming_phone_number_local(
    ...
    models::ListIncomingPhoneNumberLocalResponse,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListIncomingPhoneNumberLocalError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
