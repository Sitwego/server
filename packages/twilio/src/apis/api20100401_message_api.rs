...
pub async fn create_message(
    ...
    if let Some(param_value) = params.provide_feedback {
        multipart_form_params
            .insert("ProvideFeedback", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.content_retention {
        multipart_form_params
            .insert("ContentRetention", param_value.to_string());
    }
    if let Some(param_value) = params.address_retention {
        multipart_form_params
            .insert("AddressRetention", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.content_variables {
        multipart_form_params
            .insert("ContentVariables", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.messaging_service_sid {
        multipart_form_params
            .insert("MessagingServiceSid", param_value.to_string());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateMessageError> =
...
pub async fn delete_message(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteMessageError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn fetch_message(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchMessageError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_message(
    ...
    if let Some(ref param_value) = params.date_sent {
        req_builder =
            req_builder.query(&[("DateSent", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListMessageError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn update_message(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateMessageError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
