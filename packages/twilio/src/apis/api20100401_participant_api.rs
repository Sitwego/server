...
pub async fn create_participant(
    ...
    models::ApiV2010AccountConferenceParticipant,
...
> {
    ...
    if let Some(param_value) = params.start_conference_on_enter {
        multipart_form_params
            .insert("StartConferenceOnEnter", param_value.to_string());
    }
    if let Some(param_value) = params.end_conference_on_exit {
        multipart_form_params
            .insert("EndConferenceOnExit", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.max_participants {
        multipart_form_params
            .insert("MaxParticipants", param_value.to_string());
    }
    if let Some(param_value) = params.conference_record {
        multipart_form_params
            .insert("ConferenceRecord", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.conference_status_callback {
        multipart_form_params
            .insert("ConferenceStatusCallback", param_value.to_string());
    }
    if let Some(param_value) = params.conference_status_callback_method {
        multipart_form_params
            .insert("ConferenceStatusCallbackMethod", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.recording_channels {
        multipart_form_params
            .insert("RecordingChannels", param_value.to_string());
    }
    if let Some(param_value) = params.recording_status_callback {
        multipart_form_params
            .insert("RecordingStatusCallback", param_value.to_string());
    }
    if let Some(param_value) = params.recording_status_callback_method {
        multipart_form_params
            .insert("RecordingStatusCallbackMethod", param_value.to_string());
    }
    if let Some(param_value) = params.sip_auth_username {
        multipart_form_params
            .insert("SipAuthUsername", param_value.to_string());
    }
    if let Some(param_value) = params.sip_auth_password {
        multipart_form_params
            .insert("SipAuthPassword", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.jitter_buffer_size {
        multipart_form_params
            .insert("JitterBufferSize", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.machine_detection {
        multipart_form_params
            .insert("MachineDetection", param_value.to_string());
    }
    if let Some(param_value) = params.machine_detection_timeout {
        multipart_form_params
            .insert("MachineDetectionTimeout", param_value.to_string());
    }
    if let Some(param_value) = params.machine_detection_speech_threshold {
        multipart_form_params
            .insert("MachineDetectionSpeechThreshold", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.machine_detection_silence_timeout {
        multipart_form_params
            .insert("MachineDetectionSilenceTimeout", param_value.to_string());
    }
    if let Some(param_value) = params.amd_status_callback {
        multipart_form_params
            .insert("AmdStatusCallback", param_value.to_string());
    }
    if let Some(param_value) = params.amd_status_callback_method {
        multipart_form_params
            .insert("AmdStatusCallbackMethod", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.client_notification_url {
        multipart_form_params
            .insert("ClientNotificationUrl", param_value.to_string());
    }
    if let Some(param_value) = params.caller_display_name {
        multipart_form_params
            .insert("CallerDisplayName", param_value.to_string());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateParticipantError> =
...
pub async fn delete_participant(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteParticipantError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchParticipantError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_participant(
    ...
    if let Some(ref param_value) = params.coaching {
        req_builder =
            req_builder.query(&[("Coaching", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListParticipantError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateParticipantError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
