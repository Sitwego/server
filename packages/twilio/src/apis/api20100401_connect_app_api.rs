...
pub async fn delete_connect_app(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<DeleteConnectAppError> =
...
pub async fn fetch_connect_app(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchConnectAppError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_connect_app(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListConnectAppError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn update_connect_app(
    ...
    if let Some(param_value) = params.authorize_redirect_url {
        multipart_form_params
            .insert("AuthorizeRedirectUrl", param_value.to_string());
    }
    ...
    if let Some(param_value) = params.deauthorize_callback_method {
        multipart_form_params
            .insert("DeauthorizeCallbackMethod", param_value.to_string());
    }
    if let Some(param_value) = params.deauthorize_callback_url {
        multipart_form_params
            .insert("DeauthorizeCallbackUrl", param_value.to_string());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateConnectAppError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
