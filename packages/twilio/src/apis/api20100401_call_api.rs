...
pub async fn create_call(
    ...
    if let Some(param_value) = params.async_amd_status_callback {
        multipart_form_params
            .insert("AsyncAmdStatusCallback", param_value.to_string());
    }
    if let Some(param_value) = params.async_amd_status_callback_method {
        multipart_form_params
            .insert("AsyncAmdStatusCallbackMethod", param_value.to_string());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateCallError> =
...
pub async fn delete_call(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteCallError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn fetch_call(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchCallError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn list_call(
    ...
    if let Some(ref param_value) = params.parent_call_sid {
        req_builder =
            req_builder.query(&[("ParentCallSid", &param_value.to_string())]);
    }
    if let Some(ref param_value) = params.status {
        req_builder =
            req_builder.query(&[("Status", &param_value.to_string())]);
    }
    if let Some(ref param_value) = params.start_time {
        req_builder =
            req_builder.query(&[("StartTime", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = params.end_time {
        req_builder =
            req_builder.query(&[("EndTime", &param_value.to_string())]);
    }
...
pub async fn update_call(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateCallError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
