...
pub struct CreateIncomingPhoneNumberMobileParams {
    ...
    pub emergency_status:
        Option<models::IncomingPhoneNumberMobileEnumEmergencyStatus>,
    ...
    pub voice_receive_mode:
        Option<models::IncomingPhoneNumberMobileEnumVoiceReceiveMode>,
...
pub async fn list_incoming_phone_number_mobile(
    ...
    models::ListIncomingPhoneNumberMobileResponse,
