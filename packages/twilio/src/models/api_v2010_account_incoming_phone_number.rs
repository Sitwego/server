...
pub struct ApiV2010AccountIncomingPhoneNumber {
    ...
    pub address_requirements:
        Option<models::IncomingPhoneNumberEnumAddressRequirement>,
    ...
    pub capabilities: Option<
        Option<Box<models::ApiV2010AccountIncomingPhoneNumberCapabilities>>,
    >,
    ...
    pub emergency_address_status:
        Option<models::IncomingPhoneNumberEnumEmergencyAddressStatus>,
